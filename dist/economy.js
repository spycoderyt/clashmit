...
export const ATTACKS={
 ...
 skeletonArmy:{name:'Skeletons',upgrade:'Super Skeleton',icon:'☠',damage:0,upDamage:0,manaCost:4,cooldown:5000,flightMs:1500,swarm:{perSecond:5,duration:5000},upSwarm:{perSecond:7,duration:5000},words:['skeleton army','skeletons','skeleton','super skeleton','super skeletons','super skeleton army','supper skeleton','super skelton','bone legion','bone region']},

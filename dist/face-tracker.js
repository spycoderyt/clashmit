...
import {createFaceTracks} from './face-tracks.js?v=face10';
import {startFaceEngine,detectFaces,grabRegion,clampRegion} from './face-client.js?v=face10';
...
export function createFaceTracker(video,{getGallery,onStatus=()=>{},focus={x:.5,y:.4}}){
 ...
 function startBodyWorker(){
  ...
  try{bodyWorker=new Worker(new URL('./detection-worker.js?v=face10',import.meta.url));}catch{return;}
